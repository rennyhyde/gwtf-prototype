...
TANK_0_PORT = "../../../../dev/serial/by-path/platform-xhci-hcd.0-usb-0:2:1.0"   # left arm  — change to "COM3" etc. on Windows
TANK_1_PORT = ../../../.."/dev/serial/by-path/platform-xhci-hcd.1-usb-0:2:1.0"              # right arm — set when second ESP32 is ready
